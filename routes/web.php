...
// Autentikasi Laravel dengan Rate Limiting
// Mencegah brute force attack pada login (max 5 percobaan per menit)
Route::middleware(['throttle:5,1'])->group(function () {
    Auth::routes();
});

// Dashboard setelah login (bisa diarahkan sesuai role)
